...
export default class ThirteenClassThailand extends Component {
  render() {
    return (
        <div className="container-3 w-container">
            <h3 className="heading-66">13 Day Classic Thailand</h3>
            <div className="divider grey"></div>
            <p className="paragraph-14">
                13 Days Tour<br />
                Bangkok, Ayutthaya, Sukhothai, Chiang Rai, Chiang Mai<br />
                From $999 (land) or $1489 (air &amp; land) and up<br />Sep 2019 - May 2020</p>
            <h3 className="heading-68">Package Includes</h3>
            <p className="paragraph-15">
                • Round trip flights Los Angeles-Bangkok, Bangkok-Los Angeles<br />
                Other departure cities available.<br />
                • Airline taxes &amp; fuel surcharges<br />
                • Intra-flight Chiang Mai-Bangkok<br />
                • 11 nights First Class accommodations<br />
                - 4 nights Bangkok<br />
                - 1 night Ayutthaya<br />
                - 1 night Sukhothai<br />
                - 2 nights Chiang Rai<br />
                - 3 nights Chiang Mai<br />
                ...
                • 18 meals: 11 breakfasts, 3 lunches, 4 dinners with wine or beer<br />
            ...
            <p className="paragraph-16">
                ...
                • Visit Bang Pa-In Royal Palace, used as a summer palace by the Siamese royalty<br />
                • Marvel at Chai Wattanaram Temple, one of Ayutthaya’s most impressive remaining monuments<br />
                • Explore Historical Sukhothai, capital of the first Kingdom of Siam<br />
                • Visit the House of Opium and Golden Triangle<br />
                • Discover Wat Phrathat Doi Suthep Temple, the most sacred temple in Northern Thailand<br />• Authentic Thai Dinner at Chiang Mai Private Home</p>
            <h3 className="heading-69">Itinerary</h3>
            <p className="paragraph-17">
                <strong>
                    <em>Note: your itinerary will change depending upon the day of the week you depart.</em>
                    <br />
                    <br />DAY 1 - Depart for Thailand
    </strong>
                <br />
                Depart for Thailand<br />
                <br />
                ‍<strong>DAY 2 - Arrive in Bangkok</strong><br />
                ...
                *<em>Entering Myanmar (Burma) requires a border crossing fee of approx US$40, payable locally. The opportunity to cross the border will depend on local conditions and cannot be guaranteed. If the border crossing is not possible, alternate arrangements will be made</em><br />
                ...
                <strong>Meals:</strong> Breakfast<br />
                <br />
                ‍<strong>DAY 13 - Depart Thailand</strong><br />
