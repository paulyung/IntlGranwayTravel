                    ...
                    <div>
                        ...
                        <div style={{ width: '66%',  float: 'left', display: 'inline-block', paddingLeft: '10px' }}>
                            ...
                            <p className="paragraph-2">
                                ...
                                7 Days | 3 Ports <br />
                                Round trip from Los Angeles<br />
                                Ruby Princess<br />
                                Starting from $398 per person<br />
                            </p>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div style={{ width: '66%', float: 'left', display: 'inline-block', paddingLeft: '10px' }}>
                            ...
                            <p className="paragraph-3">
                                ...
                                7 Days | 3 Ports<br />
                                Round trip from Ft. Lauderdale, Florida<br />
                                Caribbean Princess<br />Starting from $498 per person
              </p>
                        </div>
                    </div>
                </a>
                    ...
                    <div>
                        ...
                        <div style={{ width: '66%', float: 'left', display: 'inline-block', paddingLeft: '10px' }}>
                            ...
                            <p className="paragraph-4">
                                ...
                                Starting from $548 per person<em></em>
                            </p>
                        </div>
                    </div>
                </a>
                    ...
                    <div>
                        ...
                        <div style={{ width: '66%', float: 'left', display: 'inline-block', paddingLeft: '10px' }}>
                            ...
                            <p className="paragraph-2">
                                ...
                                7 Days | 5 Ports<br />
                                Emerald Princess<br />Starting from $1239 per person
              </p>
                        </div>
                    </div>
                </a>
                    ...
                    <div>
                        ...
                        <div style={{ width: '66%', float: 'left', display: 'inline-block', paddingLeft: '10px' }}>
                            ...
                            <p className="paragraph-2">
                                ...
                                10 Days | 6 Ports<br />
                                Island Princess<br />Starting from $763 per person
              </p>
                        </div>
                    </div>
                </a>
                    ...
                    <div>
                        ...
                        <div style={{ width: '66%', float: 'left', display: 'inline-block', paddingLeft: '10px' }}>
                            ...
                            <p className="paragraph-2">
                                ...
                                11 Days | 6 Ports<br />
                                Round trip from Copenhagen, Denmark<br />
                                Regal Princess<br />Starting from $2049 per person
              </p>
                        </div>
                    </div>
                </a>
                    ...
                    <div>
                        ...
                        <div style={{ width: '66%', float: 'left', display: 'inline-block', paddingLeft: '10px' }}>
                            ...
                            <p className="paragraph-2">
                                ...
                                12 Days | 9 Ports<br />
                                Roundtrip from London (Southampton), England<br />
                                Crown Princess<br />Starting from $1899 per person
              </p>
                        </div>
                    </div>
                </a>
